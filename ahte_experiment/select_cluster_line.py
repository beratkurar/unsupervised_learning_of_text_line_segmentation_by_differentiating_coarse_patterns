...
vis_folder=dataset_name+'_exp_results/test_results/upsampled_cubic/'
org_folder='../datasets/'+dataset_name+'_dataset/'+dataset_name+'_test'
line_folder=dataset_name+'_exp_results/test_results/upsampled_cubic_binary/'
